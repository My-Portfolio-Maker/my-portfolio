...
import { getPhoneNumber, handleImage } from "../../../../utils";
        ...
        <div className="container">
          <div className="row justify-content-center mb-5 pb-3">
            <Heading
              className={"col-md-7"}
              title="Contact Me"
              subtitle="If you're seeking a dedicated and self-assured developer who can bring creative ideas to life, let's connect!"
              bgTitle="Contact"
            />
          </div>
          ...
          <div className="row no-gutters block-9 pt-2">
            ...
            <div className="col-md-6 d-flex contact-image">
              {/* <div
              className="img"
